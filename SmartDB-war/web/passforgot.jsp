        ...
        <div id="headerwrap">
            <div class="container">
                <div class="row centered">
                    <div class="col-lg-12">
                        <h3>Renseigner votre email pour recevoir votre nouveau mot de passe.</h3>
                        <br>
                        <br>
                        ...
                        <div>
                            ...
                            <form name="login" role="form" class="form-horizontal" method="post" accept-charset="utf-8">
                                ...
                                <div class="form-group">
                                    <div><input name="password" placeholder="Email" class="form-control" type="password" id="UserMail"/></div>
                                </div> 

                                <div class="form-group">
                                    <div ><input  class="btn btn-success btn btn-success" name="getpwd" type="submit" value="Reinitialiser le mot de passe"/></div>
                                </div>
