	    ...
	    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="index.jsp"><img src="assets/logo.png" height="46px"/></a>
	        </div>
	        <div class="navbar-collapse collapse">
	          <ul class="nav navbar-nav">
	            <li><a href="index.jsp" class="smothscroll">Home</a></li>
	            <li class="active"><a href="register.jsp" class="smothScroll">Register</a></li>
                    <li><a href="signin.jsp" class="smothScroll">Sign In</a></li>
	          </ul>
	        </div><!--/.nav-collapse -->
	      </div>
	    </div>
